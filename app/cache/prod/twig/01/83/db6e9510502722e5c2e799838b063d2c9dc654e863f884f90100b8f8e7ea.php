...
class __TwigTemplate_0183db6e9510502722e5c2e799838b063d2c9dc654e863f884f90100b8f8e7ea extends Twig_Template
{
    ...
    ";
        ...
        <h2><a href=\"";
            // line 9
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("facturation_details", array("id" => $this->getAttribute((isset($context["facture"]) ? $context["facture"] : null), "id"))), "html", null, true);
            echo "\">";
